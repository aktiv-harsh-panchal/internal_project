pipeline {
    ...
    stages {
         ...
         * ==========================================
         *
         * Jenkins MUST have passwordless sudo
         * permission for /usr/bin/fuser.
         */
            ...
            steps {
                ...
                sh '''
                    ...
                    if ss -ltn | grep -q ":${ODOO_PORT} "; then
                        ...
                        echo "Checking sudo permission for Jenkins..."


                        if ! sudo -n -v 2>/dev/null; then

                            echo "ERROR: Jenkins does not have passwordless sudo permission."

                            echo ""

                            echo "Please configure sudoers for Jenkins."

                            echo "Required permission: /usr/bin/fuser"
                        ...
                        echo "Stopping Odoo process..."

                        sudo -n fuser -k ${ODOO_PORT}/tcp


                        echo ""

                        echo "Waiting for port ${ODOO_PORT} to be released..."
                        ...
                        do
                            ...
                            if ! ss -ltn | grep -q ":${ODOO_PORT} "; then
                                ...
                                echo "Port ${ODOO_PORT} has been released."
                            ...
                            echo "Port still in use... waiting (${i}/30)"
                        ...
                        echo "Port ${ODOO_PORT} is already free."
        ...
        stage('Start Odoo') {
            ...
            steps {
                ...
                sh '''
                    ...
                    echo "Waiting for port ${ODOO_PORT}..."
